...
var P_LY = {
    ...
    allViewFlag: true, //选择区域时用来屏蔽点击事件
    ...
    Plug: {
        type: '',
        ver: '2.0.18.112', // webcu
        eVer: '2.0.17.830', // embed
        inited: false,
        nc: null,
        wnd: null,
        wa: null, // - 插件容器
                        ...
                        try {
                            ...
                            switch (name) {
                                ...
                                case P_LY.Enum.NCObjectNotify.gps_data_notify:
                                    ...
                                    break;
                                case P_LY.Enum.NCObjectNotify.opc_data_notify:
                                    _ncnStruct = new P_LY.Struct.NCObjectNotifyStruct(
                                        name,
                                        args1,
                                        null,
    ...
    */
                    ...
                    case P_LY.Enum.ForkResourceLevel.nppForkOnePUInfo:
                        ...
                        if (_connStruct.connType == P_LY.Enum.ConnectionType.Device) {
                            if (!puid) {
                                ...
                                if (operator.rv == P_Error.SUCCESS) {
                                    if (operator.response && operator.response.M && operator.response.M.C && operator.response.M.C.Res && operator.response.M.C.Res.Param && operator.response.M.C.Res.Param.Value) {
    ...
    desc: 获取平台用户信息
    returns:
    	- succ <response: Array(P_LY.Struct.UserStruct)>
    params:
		- connectId(string) * 连接ID
    ... 
    */
    GetUserList: function(connectId) {
        try {
            ...
            if (!connectId || !P_LY.Connections.get(connectId)) {
                ...
                var requestXML = '<?xml version="1.0" encoding="utf-8"?><M Type="CusReq"><C Type="C" OptID="C_CAS_QueryUserList"/></M>';
                ...
                if (operator.rv == P_Error.SUCCESS) {
                    ...
                    if (typeof XML != "undefined" && typeof XML.ObjTree != "undefined") {
                        ...
                        } else if (typeof _response == "object" && _response.M && _response.M.C && _response.M.C.User) {
                            User = _response.M.C.User || [];
        ...
        ForkInfoByPUHandle: function(connectId, _puHandle) {
            try {
                ...
                if (!_puHandle) {
                    ...
                    var _infors = [{
                        _method: "GetResourcePUID",
                        _property: "puid",
                        _value: ""
                    }, {
                        _method: "GetResourceName",
                        _property: "name",
                        _value: ""
                    }, {
                        _method: "GetResourceDesc",
                        _property: "description",
                        _value: ""
                    }, {
                        _method: "GetPUOnlineFlag",
                        _property: "online",
                        _value: ""
                    }, {
                        _method: "GetResourceEnable",
                        _property: "enable",
                        _value: ""
                    }, {
                        _method: "GetResourceUsable",
                        _property: "usable",
                        _value: ""
                    }, {
                        _method: "GetPUModelType",
                        _property: "modelType",
                        _value: ""
                    }, {
                        _method: "GetResourceType",
                        _property: "resourceType",
                        _value: ""
                    }, {
                        _method: "GetPULatitude",
                        _property: "latitude",
                        _value: ""
                    }, {
                        _method: "GetPULongitude",
                        _property: "longitude",
                        _value: ""
                    }, {
                        _method: "GetResourceUsable",
                        ...
                        _method: "GetPUModelName",
                        _property: "modelName",
                        _value: ""
                    }, {
                        _method: "GetPUManufactureID",
                        _property: "manufactrueID",
                        _value: ""
                    }, {
                        /*
    ...
    */
    CreateWindow: function(connectId, containerOrId, windowType, windowEvent, customParams) {
        try {
            ...
            //console.log(winObj)
            //开启鹰眼模式
            if (windowEvent.all_view) {

                winObj.all_view = true;
                windowEvent.lbtn_double_click.status = true;
                windowEvent.lbtn_double_click.callback = function(arg) {
                    P_LY.FullScreen(arg)
                }
                ...
                windowEvent.lbtn_click.callback = function() {
                    ...
                    if (obj.is_view) {
                        if (P_LY.allViewFlag) {
                            ...
                            x = arguments[1];
                            y = arguments[2];
                            var width = document.getElementById(obj.containerId).clientWidth;
                            var height = document.getElementById(obj.containerId).clientHeight;
                            BeginX = parseInt(x * 1000 / width);
                            BeginY = parseInt(y * 1000 / height);
                            var rv = P_LY.Control.CommonSet(
                                connectId, {
                                    puid: winObj.params.puid,
                                    resType: "PTZ",
                                    resIdx: winObj.params.idx,
                                    controlID: "C_PTZ_SelectZoom",
                                    param: '<Param  BeginX="' + BeginX + '" BeginY="' + BeginY + '" EndX="' + BeginX + '" EndY="' + BeginY + '" />'
                                }
                            )
                        } else {
                            P_LY.allViewFlag = true;
                            var node = P_LY.WindowContainers.get(obj.containerId)
                            var newWindow = node.window;
                            var rv = P_IF.SetLayerRect(newWindow.wnd, 0, 0, 0, 0);
                        }
                    }

                }

                windowEvent.select_rect.status = true;
                windowEvent.select_rect.callback = function() {
                    var obj = arguments[0]
                        //	console.log(obj)
                    if (obj.is_view) {
                        P_LY.allViewFlag = false;
                        ...
                        var rv = P_IF.SetLayerRect(obj.wnd, x1, y1, x2, y2);
                        var BeginX = 0,
                            BeginY = 0,
                            EndX = 0,
                            EndY = 0;
                        var width = document.getElementById(obj.containerId).clientWidth;
                        var height = document.getElementById(obj.containerId).clientHeight;
                        BeginX = parseInt(x1 * 1000 / width);
                        BeginY = parseInt(y1 * 1000 / height);
                        EndX = parseInt(x2 * 1000 / width);
                        EndY = parseInt(y2 * 1000 / height);

                        var rv = P_LY.Control.CommonSet(
                            connectId, {
                                puid: obj.params.puid,
                                resType: "PTZ",
                                resIdx: obj.params.idx,
                                controlID: "C_PTZ_SelectZoom",
                                param: '<Param  BeginX="' + BeginX + '" BeginY="' + BeginY + '" EndX="' + EndX + '" EndY="' + EndY + '" />'
                            }
                        );
                    }
                }
            }
            windowEvent.key_up.status = true;
            windowEvent.key_up.callback = function() {
                console.log(arguments[1])
            }
            windowEvent.key_down.status = true;
            windowEvent.key_down.callback = function() {
                    console.log(arguments[1])
                }
                // - 初始化绑定窗口事件
	...
	*/
    WindowAttachEvent: {
                        ...
                        var _callback = function() {
                            ...
                            switch (name) {
                                case "lbtn_click":
                                    ...
                                    break;
                                case "lbtn_double_click":
                                    _SELF.Fire_lbtn_double_click.apply(_SELF, _argsArr);
                                    break;
                                case "select_rect":
        ...
        */
        ...
        // - 左键双击
        Fire_lbtn_double_click: function(winObj, x, y) {
            P_Utils.Log("Fire_lbtn_double_click", "xPos ->" + x + ", yPos -> " + y);
        },
        // - 选择矩形框
        ...
        // - 自定义右键菜单
        Fire_menu_command: function(winObj, _keyCode, _callback, winHandle) {
    ...
    */
    ...
    // - 是否允许全景视频一点即视频功能
    EnableClickView: function(objWnd, bValue) {
        console.log(objWnd, bValue)
        try {
            var fn = "P_LY.EnableClickView";

            if (objWnd && objWnd.wnd) {
                var bValue = (bValue || 0) != 1 ? 0 : 1;
                P_IF.EnableLayerRect(objWnd.wnd, bValue);
                P_LY.WindowControlMode.set(objWnd, bValue);
                return new P_LY.Struct.ReturnValueStruct(P_Error.SUCCESS);
            } else {
                P_Utils.Log(fn, "objWnd wnd not exist~");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR_WINDOW_NOTEXIST);
    ...
    PlayVideo: function(connectId, objWnd, puid, idx, streamType, customParams) {
        ...
        try {
            ...
            if (objWnd && objWnd.wnd) {
                ...
                //	var rv = P_IF.EnableFixAspectRatio(_connStruct.nc,iaStreamHandle, 0);
                //	var rv1 = P_IF.EnableAutoFixAspectRatio(_connStruct.nc,iaStreamHandle, 0);

                if (objWnd.all_view) {
                    var rv = P_IF.EnableLayerRect(objWnd.wnd, 1);
                    P_LY.WindowControlMode.set(objWnd, 1);
                }
                ...
                //P_IF.EnableDoubleClickFullScreen(objWnd, false);
...
　　		- 点播前端CEFS录像，type=P_LY.Enum.StorageFileType.CEFS时，可选下列参数传入puid、ivIndex、speed、direction、beginTime、endTime
	...
	*/
    PlayVod: function(connectId, objWnd, options) {
        ...
        try {
            ...
            //禁用窗口点击全屏
            //	P_IF.EnableDoubleClickFullScreen(objWnd.wnd, false);
	...
	*/
    VODRecordPlayByTime: function(connectId, objWnd, options) {

        //	console.log(objWnd)
        try {
            var fn = "P_LY.VODRecordPlayByTime";
            if (!connectId || !P_LY.Connections.get(connectId)) {
                P_Utils.Log(fn, "connectId error");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR_CONNECTID_ERROR);
            }
            ...
            var operator = P_IF.VODRecordPlayByTime(
                _connStruct.nc,
                sghandle_operator.response,
                o.ivIndex,
                o.beginTime,
	...
	*/
    CSSVODRecordPlayByTime: function(connectId, objWnd, options) {

        //	console.log(objWnd)
        try {
            var fn = "P_LY.CSSVODRecordPlayByTime";
            if (!connectId || !P_LY.Connections.get(connectId)) {
                P_Utils.Log(fn, "connectId error");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR_CONNECTID_ERROR);
            }
            ...
            var operator = P_IF.CSSVODRecordPlayByTime(
                _connStruct.nc,
                _connStruct.session,
                ivhandle_operator.response,
                o.beginTime,
	...
	*/
    DownloadOPCByTime: function(connectId, options) {
        console.log(options)
        try {
            var fn = "P_LY.DownloadOPCByTime";
            if (!connectId || !P_LY.Connections.get(connectId)) {
                P_Utils.Log(fn, "connectId error");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR_CONNECTID_ERROR);
            }
            ...
            o.ivIndex = typeof o.ivIndex != "undefined" || !isNaN(o.ivIndex) ? o.ivIndex : 0;
            o.type = typeof o.type != "undefined" || !isNaN(o.type) ? o.type : 0;
            o.sgIndex = typeof o.sgIndex != "undefined" || !isNaN(o.sgIndex) ? o.sgIndex : 0;

            var _connStruct = P_LY.Connections.get(connectId);


            if (isNaN(o.beginTime) || isNaN(o.endTime)) {
                P_Utils.Log(fn, "beginTime | endTime error~");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR);
            }
            var sghandle_operator = P_LY.NPPSDKCommon.GetHandle(
                connectId,
            ...
            var operator = P_IF.DownloadOPCByTime(
                _connStruct.nc,
                sghandle_operator.response,
                o.sgIndex,
                o.type,
    ...
    params: 
		...
		- options(object) 点播相关参数
		{
			...
			sgIndex(uint) 前端点播时存储器资源索引
			ivIndex(uint) 点播对象（摄像头）资源索引，缺省为0
			filePath(string) 点播录像全路径
		}
	*/
    ExtractImageFromRecord: function(connectId, options) {

        try {
            var fn = "P_LY.ExtractImageFromRecord";
            if (!connectId || !P_LY.Connections.get(connectId)) {
                P_Utils.Log(fn, "connectId error");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR_CONNECTID_ERROR);
            }
            ...
            if (!o.filePath) {
                P_Utils.Log(fn, "fileFullPath error~");
                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR);
            }
            var sghandle_operator = P_LY.NPPSDKCommon.GetHandle(
                connectId,
            ...
            if (sghandle_operator.rv != P_Error.SUCCESS) {
                P_Utils.Log(fn, "get sg handle error~");
                if (sghandle_operator.rv == P_Error.ERROR) {
                    sghandle_operator.rv = P_Error.ERROR_HANDLE_ERROR;
                }
                return new P_LY.Struct.ReturnValueStruct(sghandle_operator.rv);
            ...
            var operator = P_IF.ExtractImageFromRecord(
                _connStruct.nc,
                sghandle_operator.response,
                o.filePath
            );
            ...
            if (operator.rv != P_Error.SUCCESS) {
                P_Utils.Log(fn, "get vod image failed~");
                return new P_LY.Struct.ReturnValueStruct((P_LY.Debug.debug ? operator.rv : P_Error.FAILED));
            }
            return new P_LY.Struct.ReturnValueStruct(P_Error.SUCCESS, operator.response);
        } catch (e) {
    ...
    /**
     * --------------------------------------------------------------------------------------------------------
     *	- s - remark: 获取平台录像第一祯图片
     * ........................................................................................................
     **/
    /*
    ---
    fn: ExtractImageFromCSSRecord 
    desc: 获取平台录像第一祯图片
    returns: 
        - P_Error
    params: 
	...
	*/
    ExtractImageFromCSSRecord: function(connectId, options) {
        ...
        try {
            ...
            operator = P_IF.ExtractImageFromCSSRecord(
                _connStruct.nc,
                _connStruct.session,
                o.szId,
                o.filePath
    ...
    // - 设置播放速度
    SetPlaySpeed: function(objWnd, speed) {
        try {

            var fn = "P_LY.SetPlaySpeed";
            if (objWnd && objWnd.wnd) {
                var connectId = objWnd.connectId;
                if (connectId && P_LY.Connections.get(connectId)) {
                    var _connStruct = P_LY.Connections.get(connectId);
                    ...
                    if (objWnd.status.playvoding) {
                        var ivStreamHandle = objWnd.params.ivStreamHandle;
                        P_IF.SetPlaySpeed(_connStruct.nc, ivStreamHandle, speed);
                    }
                    return new P_LY.Struct.ReturnValueStruct(P_Error.SUCCESS);
                } else {
            ...
            if (objWnd && objWnd.wnd) {
                ...
                if (connectId && P_LY.Connections.get(connectId)) {
                    ...
                    if (objWnd.status.playvoding) {
                        ...
                        if (objWnd.status.playaudioing) {
                            P_IF.CloseAudio(_connStruct.nc, ivStreamHandle);
                        }
    ...
    */
    ...
    params: 
        - objWnd(P_LY.Struct.WindowStruct) * 窗口对象
    */
    CloudRecord: function(objWnd, options) {
        try {
            var fn = "P_LY.LocalRecord";
            if (objWnd && objWnd.wnd) {
                var connectId = objWnd.connectId;
                ...
                if (objWnd.status.playvideoing || objWnd.status.playvoding) {
                    if (!objWnd.status.cloudrecording) {
                        var xmlOSets = "";
                        xmlOSets += "<OSets>";
                        xmlOSets += '<Res OType="201" OID="' + objWnd.params.puid + '" Type="IV" Idx="' + objWnd.params.idx + '"  ><Param Value="0"></Param></Res>';
                        xmlOSets += '<Res OType="201" OID="' + objWnd.params.puid + '" Type="IA" Idx="' + objWnd.params.idx + '"  ><Param Value="0"></Param></Res>';
                        xmlOSets += "</OSets>";
                        var paramAttrs = 'Reason="Manual" Duration="' + o.Duration + '" Type="0" ReserveDay="' + o.ReserveDay + '" FileLength="' + o.FileLength + '"';
                        ...
                        var rv = P_LY.Control.CommonGet(
                            connectId, {
                                ...
                                language: 'zh_CN',
                                resType: "ST",
                                resIdx: objWnd.params.idx,
                                controlID: "C_CSS_StartManualStorage",
                                domainRoad: "",
                                xmlObjSets: xmlOSets,
                        ...
                        if (rv.M && rv.M.C && rv.M.C.Res && rv.M.C.Res.Param) {
                            objWnd.status.cloudrecording = true;
                            objWnd.params.cloudRecordID = rv.M.C.Res.Param.ID;
                        } else {
                            objWnd.status.cloudrecording = false;
                            objWnd.params.cloudRecordID = "";
                        }
                    } else {
                        var ID = objWnd.params.cloudRecordID;
                        var paramAttrs = 'ID="' + ID + '"';
                        var rv = P_LY.Control.CommonGet(
                            connectId, {
                                puid: objWnd.params.puid,
                                language: 'zh_CN',
                                resType: "ST",
                                resIdx: objWnd.params.idx,
                                controlID: "C_CSS_StopManualStorage",
                                domainRoad: "",
                                xmlObjSets: "",
                                param: '<Param ' + paramAttrs + ' />'
                            }
                        ).response;
                        if (rv.M && rv.M.C && rv.M.C.Res) {
                            objWnd.status.cloudrecording = false;
                            objWnd.params.cloudRecordID = "";
                        }
    ...
    */
    ...
    //		cloudSnapshotID : "" , // - 云抓拍存储事务ID

    CloudSnapshot: function(objWnd, options) {
        try {
            var fn = "P_LY.LocalRecord";
            if (objWnd && objWnd.wnd) {
                var connectId = objWnd.connectId;
                ...
                if (objWnd.status.playvideoing || objWnd.status.playvoding) {
                    if (!objWnd.status.cloudsnapshoting) {
                        var xmlOSets = "";
                        xmlOSets += "<OSets>";
                        xmlOSets += '<Res OType="201" OID="' + objWnd.params.puid + '" Type="IV" Idx="' + objWnd.params.idx + '"  ><Param Value="0"></Param></Res>';
                        xmlOSets += "</OSets>";
                        var paramAttrs = 'Reason="Manual" Duration="' + o.Duration + '"  ReserveDay="' + o.ReserveDay + '" Interval="' + o.Interval + '"';
                        ...
                        var rv = P_LY.Control.CommonGet(
                            connectId, {
                                ...
                                resType: "ST",
                                resIdx: objWnd.params.idx,
                                controlID: "C_CSS_StartManualSnapshot",
                                domainRoad: "",
                                xmlObjSets: xmlOSets,
                                param: '<Param ' + paramAttrs + ' />'
                            }
                        ...
                        if (rv.M && rv.M.C && rv.M.C.Res && rv.M.C.Res.Param) {
                            objWnd.status.cloudsnapshoting = true;
                            objWnd.params.cloudSnapshotID = rv.M.C.Res.Param.ID;
                        } else {
                            objWnd.status.cloudsnapshoting = false;
                            objWnd.params.cloudSnapshotID = "";
                        }
                    } else {
                        var ID = objWnd.params.cloudSnapshotID;
                        var paramAttrs = 'ID="' + ID + '"';
                        var rv = P_LY.Control.CommonGet(
                            connectId, {
                                puid: objWnd.params.puid,
    ...
    */
    ...
    CloudSnapshotOne: function(objWnd, options) {
        try {
            var fn = "P_LY.LocalRecord";
            if (objWnd && objWnd.wnd) {
                var connectId = objWnd.connectId;
    ...
    */
    ...
    ... 
    */
    AllFullScreen: function(connectId, WndNumber) {

        try {
            var fn = "P_LY.AllFullScreen";
            if (WndNumber > 0) {
                var nc = "";
                if (document.getElementById("multi_window")) {
                    container = document.getElementById("multi_window");
                    nc = container.firstChild;
                } else {
                    var winbox = document.createElement("DIV");
                    winbox.setAttribute("id", "multi_window");
                    winbox.setAttribute("attention", "For np sdk private using, be sure won't remove it manually...");
                    document.getElementsByTagName("body").item(0).appendChild(winbox);
                    container = document.getElementById("multi_window");
                    var t_wndname = container.id + "_wnd";
                    container.innerHTML = P_LY.Plug.Html.get("wnd", t_wndname);
                    nc = container.firstChild || document.getElementById(t_wndname);
                }

                P_IF.AttachObjectEvent(nc, "multi_full_screen_window_hide", function() {
                    if (P_LY.WindowContainers instanceof P_Utils.Hash) {
                        P_LY.WindowContainers.each(
                            function(item, index) {
                                ...
                                if (winObj && winObj instanceof P_LY.Struct.WindowStruct) {
                                    if (winObj.status.playvideoing) {
                                        winObj.status.ismultifullscreening = false;
                                        winObj.wndHandle = winObj.oldHandle;
                                        winObj.wnd["NPP_tmpWinHandle"] = winObj.wndHandle;
                                        var rv = P_IF.SetPlayWindow(P_LY.Plug.nc, winObj.params.ivStreamHandle, winObj.wndHandle);
                                    }
                                }
                            }
                        );
                ...
                var _connStruct = P_LY.Connections.get(connectId);
                var operator = P_IF.FullScreenForMultiWin(nc, WndNumber);
                ...
                if (P_LY.WindowContainers instanceof P_Utils.Hash) {
                    P_LY.WindowContainers.each(
                        function(item, index) {
                            ...
                            if (winObj && winObj instanceof P_LY.Struct.WindowStruct) {
                                if (winObj.status.playvideoing) {
                                    var _newWinHandle = operator.response[index].handle

                                    var oldHandle = winObj.wndHandle;
                                    winObj.status.ismultifullscreening = true;
                                    winObj.oldHandle = oldHandle;
                                    winObj.wndHandle = _newWinHandle;
                                    winObj.wnd["NPP_tmpWinHandle"] = _newWinHandle;
                                    var rv = P_IF.SetPlayWindow(P_LY.Plug.nc, winObj.params.ivStreamHandle, _newWinHandle);
                                }
                            }
                        }
                    );
    ...
    */
    ...
    Download: {
        ...
        */
        ...
        //查询云存储录像或者图片，type 0是录像，1是图片
        StartCloudFileDownload: function(connectId, szId, fileAllPath, localSaveAsFile, offset, type) {
            return P_LY.Download.__Sdk_DLControl(
                "cloud", {
                    connectId: connectId || null,
                    szId: szId || null,
        ...
        */
		...
		params:
			...
			- localSaveAsFile(string) * 下载保存全路径，如C:/vod.avi，上层调用时确保正确的存储路径
		*/
        DownloadRecordByTime: function(connectId, puid, sgIndex, ivIndex, beginTime, endTime, localSaveAsFile) {
            return P_LY.Download.__Sdk_DLControl(
                "dlcefsvodbytime", {
                    connectId: connectId || null,
                    puid: puid || null,
            ...
            try {
                ...
                switch (action) {
                        ...
                        if (_dlhash.get(options.connectId)) {
                            ...
                            if (_connStruct.status == P_LY.Enum.ConnectionStatus.Connected) {
                                if (options.type == 0) {
                                    ...
                                    operator = P_IF.DownloadCloudSnapshot(_connStruct.nc, _connStruct.session, options.szId, options.fileAllPath, options.localSaveAsFile);
                                }
                            } else {
                                P_Utils.Log(fn, "hav't connected~");
                                return new P_LY.Struct.ReturnValueStruct(P_Error.ERROR);
                    ...
                    case "dlcefsvod": // - 下载CEFS录像
                        ...
                        break;
                    case "dlcefsvodbytime": // - 按照时间段下载前端录像
                        ...
                        if (_dlhash.get(options.connectId)) {
                            ...
                            operator = P_LY.NPPSDKCommon.GetNCResponse(
                                options.connectId,
                                P_LY.Enum.NCObjectMethodList.SG_DownLoadFileByTime,
                                options.puid,
                                P_LY.Enum.PuResourceType.Storager,
                                options.sgIndex,
                                options.beginTime,
    ...
    CommonSPRequest: function(connectId, options) {
        try {
            ...
            if (_connStruct.status == P_LY.Enum.ConnectionStatus.Connected) {
                ...
                var requestXML = '<?xml version="1.0" encoding="UTF-8"?><M Type="ComReq" DomainRoad="' + options.domainRoad + '"><C Type="' + options.cmdType + '" Prio="' + priority + '" EPID="' + (_connStruct.connParam.epId || "system") + '"  Lang="' + options.language + '">' + options.xmlDstRes + '</C>' + (options.xmlObjSets || "") + '</M>';
                // console.log(options.dstType, options.dstId, requestXML)
    ...
    Control: {
        ...
        */
        CommonGet: function(connectId, reqParams) {
            ...
            if (reqParams.controlID == "C_CSS_QueryStorageFiles" || reqParams.controlID == "C_CSS_StartManualStorage" || reqParams.controlID == "C_CSS_StopManualStorage" || reqParams.controlID == "C_CSS_StartManualSnapshot") {
            ...
            } else if (reqParams.controlID == "C_LOG_QueryEventLog" || reqParams.controlID == "C_LOG_QueryOperationLog") {
    ...
    */
    ...
    Folder: {
        ...
        */
        ...
        ...
        */
        SelectFolder: function(dialogTitle) {
            return P_IF.Folder.SelectFolder(P_LY.Plug.wa, (dialogTitle || ""));
        },

        // - 选择文件
        SelectFile: function(folderPath) {
            return P_IF.Folder.SelectFile(P_LY.Plug.wa, folderPath);
        },
        ...
        */
         ...
         * 
         */
        ReadJpgFile: function(jpgFilePath) {
            return P_IF.Folder.ReadJpgFile(P_LY.Plug.wa, (jpgFilePath || ""));
        },
        /**
         * 
         */
        ReadBinFileBase64: function(FilePath) {
            return P_IF.Folder.ReadBinFileBase64(P_LY.Plug.wa, (FilePath || ""));
        },
        ...
        ReadTxtFile: function(FileName) {
            return P_IF.Folder.ReadJpgFile(P_LY.Plug.wa, (FileName || ""));
        },

        /**
         * 
         */
        WriteTxtFile: function(FileName, Content) {
            return P_IF.Folder.WriteTxtFile(P_LY.Plug.wa, (FileName || ""), (Content || ""));
        },
    ...
    Debug: {
        ...
        Note: function(fn, log, _time, _mode) {
            try {
                ...
                var _time = _time || P_Utils.DateFormat(),
                    _fn = fn || "_P_LYSDKDebugger_",
                    _log = log || "";
    ...
    Struct: {
        ...
        */
        ...
        params:
			...
			- userid(string) 用户ID
        */
        UserStruct: function(index, userid) {
            this.index = (index != null && typeof index != "undefined" ? index : "0");
            this.userid = (userid != null && typeof userid != "undefined" ? userid : "");
        },
        /*
        ---
        ...
        */
        WindowStruct: function(options) {
            ...
            this.status = {
                isddrawing: (options.status ? !!(options.status.isddrawing == true) : false),
                islittledecodelib: (options.status ? !!(options.status.islittledecodelib == true) : false),
                playvideoing: (options.status ? !!(options.status.playvoding == true) : false),
                isplaybyP2P: (options.status ? !!(options.status.isplaybyP2P == true) : false),
                playaudioing: (options.status ? !!(options.status.playaudioing == true) : false),
                recording: (options.status ? !!(options.status.recording == true) : false),
                playvideoing: (options.status ? !!(options.status.playvideoing == true) : false),
                talking: (options.status ? !!(options.status.talking == true) : false),
                talking: (options.status ? !!(options.status.talking == true) : false),
                calling: (options.status ? !!(options.status.calling == true) : false),
                calling: (options.status ? !!(options.status.calling == true) : false),
                cloudrecording: (options.status ? !!(options.status.cloudrecording == true) : false),
                cloudsnapshoting: (options.status ? !!(options.status.cloudsnapshoting == true) : false),
                playvoding: (options.status ? !!(options.status.playvoding == true) : false),
                isfullscreening: (options.status ? !!(options.status.isfullscreening == true) : false),
                ismultifullscreening: (options.status ? !!(options.status.ismultifullscreening == true) : false)
            };
        ...
        */
        ...
        params: 
			...
			- lbtn_double_click(object) 鼠标左键双击
        ...
        */
        WindowEventStruct: function(lbtn_click, lbtn_double_click, select_rect, ptz_control, fsw_show, fsw_hide, redraw_window, menu_command, key_up, key_down) {
            //全景模式
            this.all_view = false;
            ...
            this.key_up = {
                name: "key_up",
                status: (typeof key_up != "undefined" && typeof key_up.status != "undefined" ? !!(key_up.status == true) : false),
                callback: (typeof key_up != "undefined" && typeof key_up.callback != "undefined" && key_up.callback.constructor == Function ? key_up.callback : function() {})
            };
            // - 键盘松开
            this.key_down = {
                name: "key_down",
                status: (typeof key_down != "undefined" && typeof key_down.status != "undefined" ? !!(key_down.status == true) : false),
                callback: (typeof key_down != "undefined" && typeof key_down.callback != "undefined" && key_down.callback.constructor == Function ? key_down.callback : function() {})
            };
            ...
            // - 鼠标左键双击
            this.lbtn_double_click = {
                name: "lbtn_double_click",
                status: (typeof lbtn_double_click != "undefined" && typeof lbtn_double_click.status != "undefined" ? !!(lbtn_double_click.status == true) : false),
                callback: (typeof lbtn_double_click != "undefined" && typeof lbtn_double_click.callback != "undefined" && lbtn_double_click.callback.constructor == Function ? lbtn_double_click.callback : function() {})
            };
            // - 矩形框选择
            this.select_rect = {
                name: "select_rect",
            ...
            this.ptz_control = {
                ...
                drag_left: {
                    ...
                    callback: (typeof ptz_control != "undefined" && typeof ptz_control.drag_left.callback != "undefined" && ptz_control.drag_left.callback.constructor == Function ? ptz_control.drag_left.callback : function() {})
                },
                // - 向右拖拽
                drag_right: {
                    name: "drag_right",
                    ...
                    callback: (typeof ptz_control != "undefined" && typeof ptz_control.drag_right.callback != "undefined" && ptz_control.drag_right.callback.constructor == Function ? ptz_control.drag_right.callback : function() {})
                },
                // - 停止拖拽
                drag_stop: {
                    name: "drag_stop",
    ...
    Enum: {
        ...
        */
        NCObjectNotify: {
            ...
            /* 接收流状态通知 */
            "gps_data_notify": "gps_data_notify",
            /* 接收GPS信息通知 */
            "opc_data_notify": "opc_data_notify" /* 接收OPC信息通知 */
        },
        // - 流状态描述
        StreamStatusDesc: {
