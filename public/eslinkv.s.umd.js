...
var ruler_store_actions = {
  ...
  zoomOut: function zoomOut() {
    ...
    if (ruler_store_state.zoom > ruler_store_state.zoomStep) {
      ruler_store_state.zoom = +((ruler_store_state.zoom * 100 - step) / 100).toFixed(2);
    }
  },
