	...
	var z,
		...
		g = {
			...
			_missing: function (a) {
				...
				if (!(1 > b.totalPages)) {
					for (
						var c = this.turn('range', a), d = [], a = c[0];
						a <= c[1];
						a++
					)
				...
				var b = this,
					...
					e =
						...
						i._c.call(
							this,
							a.corner,
							c.opts.turn ? d.opts.elevation : 0,
						),
