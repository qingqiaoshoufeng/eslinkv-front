	...
	<div class="h-bg-54441 pos-a fn-flex flex-row">
		...
		<div class="pos-a h-bg-54441-num-box">
			<transition name="slide-down">
				<div class="h-bg-54441-num-5 pos-a" v-if="status5"></div>
			</transition>
			<transition name="slide-down">
				<div
					class="h-bg-54441-num-4 h-bg-54441-num-41 pos-a"
					v-if="status41"
				></div>
			</transition>
			<transition name="slide-down">
				<div
					class="h-bg-54441-num-4 h-bg-54441-num-42 pos-a"
					v-if="status42"
				></div>
			</transition>
			<transition name="slide-down">
				<div
					class="h-bg-54441-num-4 h-bg-54441-num-43 pos-a"
					v-if="status43"
				></div>
			</transition>
			<transition name="slide-down">
				<div class="h-bg-54441-num-1 pos-a" v-if="status1"></div>
			</transition>
		</div>
...
<script>
import box from './h-bg-54441-box'
...
export default {
	...
	data() {
		return {
			...
			content4: ['民生工程', '绿色工程', '安全工程', '温暖工程'],
			content5: ['跨区域发展的', '全国第一方阵的', '公众企业'],
		}
	},
	props: {
		status: {
