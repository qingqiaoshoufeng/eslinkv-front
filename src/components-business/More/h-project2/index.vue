    ...
    <div class="widget-part" :style="styles" v-if="data">
        <div class="fn-flex flex-row">
            <div class="h-project-2-left fn-flex flex-column">
                ...
                <div class="fn-flex flex-row">
                    ...
                    <div class="h-project-2-month1 pos-r" :class="{active:data.value[animateActiveIndex].month1>0}">
                        <h2 class="font-num">
                            {{data.value[animateActiveIndex].month1>0?'+':''}}{{data.value[animateActiveIndex].month1}}%</h2>
                        <p class="pos-a text-center">月度同比</p>
                    </div>
                    <div class="h-project-2-month2 pos-r" :class="{active:data.value[animateActiveIndex].month2>0}">
                        <h2 class="font-num">
                            {{data.value[animateActiveIndex].month2>0?'+':''}}{{data.value[animateActiveIndex].month2}}%</h2>
            ...
            <div class="h-project-2-right text-left">
                ...
                <div>
                    <h2 class="font-num">
                        {{data.value[animateActiveIndex].today?data.value[animateActiveIndex].today.toFixed(2):''
                        |toThousand}}</h2>
                    <p>今日接纳量(m³)</p>
                </div>
                <div>
                    <h2 class="font-num">
                        {{data.value[animateActiveIndex].quick?data.value[animateActiveIndex].quick.toFixed(2):'0'
                        |toThousand}}</h2>
                    <p>瞬时接纳量(m³/h)</p>
                </div>
            </div>
