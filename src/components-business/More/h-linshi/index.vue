<template>
	<div class="widget-part" :style="styles" v-if="data" ref="img">
		...
		<div class="container" style="padding-bottom: 10px">
			<section class="total">
				...
				<div class="total-info">
					...
					<div class="num font-num">
						{{ data.total | toThousand }}
						<span>m³</span>
					</div>
				</div>
			</section>
			<ul class="air">
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ data.air.shop | toThousand }}
						</span>
				...
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ (data.air.highPipeline / 1000) | toThousand }}
						</span>
				...
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ data.air.pressureStation | toThousand }}
						</span>
				...
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ (data.air.mediumPipeline / 1000) | toThousand }}
						</span>
						<span class="air-unit">km</span>
					</div>
				</li>
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ data.air.gasStation | toThousand }}
						</span>
						<span class="air-unit">座</span>
					</div>
				</li>
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ (data.air.lowPipeline / 1000) | toThousand }}
						</span>
						<span class="air-unit">km</span>
					</div>
				</li>
				<li class="li">
					...
					<div>
						<span class="air-num font-num">
							{{ data.air.voltageRegulator | toThousand }}
						</span>
						<span class="air-unit">个</span>
					</div>
				</li>
		...
		<div class="container">
			<section class="service">
				<ul>
					<li class="li">
						...
						<div>
							<span class="air-num font-num">
								{{ data.service.household | toThousand }}
							</span>
					...
					<li class="li">
						...
						<div>
							<span class="air-num font-num">
								{{ data.service.publicUsers | toThousand }}
							</span>
							<span class="air-unit">户</span>
						</div>
					</li>
					<li class="li">
						...
						<div>
							<span class="air-num font-num">
								{{ data.service.industrialUsers | toThousand }}
							</span>
							<span class="air-unit">户</span>
						</div>
					</li>
					<li class="li">
						...
						<div>
							<span class="air-num font-num">
								{{ data.service.inUseUsers | toThousand }}
							</span>
							<span class="air-unit">户</span>
						</div>
					</li>
					<li class="li">
						...
						<div>
							<span class="air-num font-num">
								{{ data.service.registeredUsers | toThousand }}
							</span>
							<span class="air-unit">户</span>
						</div>
					</li>
			...
			<section class="links">
				<div class="link" :class="{ active: animateActiveIndex === 0 }">
					最多跑
					<br />
					一次
				</div>
				<div class="link" :class="{ active: animateActiveIndex === 1 }">
					三社联动
					<br />
					安心安居
				</div>
				<div class="link" :class="{ active: animateActiveIndex === 2 }">
					31个
					<br />
					服务网点
				</div>
				<div class="link" :class="{ active: animateActiveIndex === 3 }">
					网上19
					<br />
					营业厅
				</div>
				<div class="link" :class="{ active: animateActiveIndex === 4 }">
					杭燃码
				</div>
			</section>
		</div>
