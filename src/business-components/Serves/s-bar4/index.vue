...
const value = {
	api: {
      ...
      data: [
        [66, 150, 356, 850, 500, 300, 400, 123, 543, 567,431],
        [100, 150, 3, 850, 65, 400, 400, 123, 543, 567,755],
        [888, 34, 580, 850, 500, 500, 400, 123, 543, 567,867]
      ]
		})
	}
}
...
.legend {
  ...
  .legend-item {
    ...
    .legend-color {
      ...
      height: 8px;
      margin-right: 4px;
      &.color1{background: #FB5325;}
      &.color2{background: #017CEF;}
      &.color3{background: #01FDD2;}
    }
    .legend-txt {
      font-size: 16px;
      line-height: 16px;
