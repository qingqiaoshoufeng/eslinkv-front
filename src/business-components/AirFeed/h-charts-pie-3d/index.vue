	...
	<div class="left-bottom-right-top">
		<div class="left-bottom-right-top-content">
			<div class="left-bottom-right-top-echarts">
				<div class="bottom-right-top-echarts-wrap" :id="`left-bottom-right-top-echarts-${randomId}`"></div>
				<div class="bottom-right-top-echarts-bg-btn" ref="pieBgBtn"></div>
				<div class="bottom-right-top-echarts-bg-top" ref="pieBgTop"></div>
			</div>
			<div class="left-bottom-right-top-text">
				<ul>
					<li v-for="(item,index) in gasPercent" :key="index+'percent'">
					<span></span>
...
const value = {
	api: {
		data: JSONStringify([
			...
			{"typeName":"工业辐射","percent":0.00},
			{"typeName":"集中供热","percent":0.00},
			{"typeName":"采暖锅炉","percent":18.00},
			{"typeName":"商业采暖","percent":2.00},
			{"typeName":"福利","percent":11.00}
		])
	}
}
export default {
