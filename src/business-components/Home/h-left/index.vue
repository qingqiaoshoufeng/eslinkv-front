<template>
	<div class="widget-part" :style="styles" v-if="data" ref="img">
      ...
      <div class="lng-top">
        <div>
          <div class="lng-num font-num">213</div>
          <div class="lng-desc">今日LNG气化量(万m³)</div>
        </div>
        <div>
          <div class="lng-num font-num">1231</div>
          <div class="lng-desc">年度LNG气化量(万m³)</div>
        </div>
      </div>
      <div class="lng-chart">
        <lngline :data="data.data1.chartData"></lngline>
      </div>
    </section>
		<section class="title">
      <img src="/static/icons/left-icon.svg">
      ...
      <img src="/static/icons/right-icon.svg">
		...
		<div class="pie">
      <pie :data="data.data2" text="区域" subtext="销售气量"></pie>
    </div>
	</div>
</template>
<script>
