import {
    ...
    DevicedId, DeviceName, DeviceStatus, DeviceLocation, F_BatteryVoltage, SolarCell, GatewaySingal, deviceType, inletPressure, outletPressure, MC, TEMP, inletTemperature, outletTemperature, h2S, ch4
} from './dictionary'
