...
export default function getPosition(x, y, zoom) {
	...
	// const LeftBottom = coordinateTransform.BD_MKT2WGS(minx, miny) // 百度墨卡托坐标-》百度经纬度坐标
	// const rightTop = coordinateTransform.BD_MKT2WGS(minx, miny) // 百度墨卡托坐标-》百度经纬度坐标
	// const leftBottomX = bd_2_HZGAS(LeftBottom[0], XB, XK)
	// const leftBottomY = bd_2_HZGAS(LeftBottom[1], YB, YK)
	// const rightTopX = bd_2_HZGAS(rightTop[0], XB, XK)
	// const rightTopY = bd_2_HZGAS(rightTop[1], YB, YK)
	return {
		// leftBottomX: 76412.62987618706,
		// leftBottomY: 80393.42309371926,
		// rightTopX: 79958.38632249985,
		// rightTopY: 83928.83690932975,
		leftBottomX,
		leftBottomY,
		rightTopX,
		rightTopY,
