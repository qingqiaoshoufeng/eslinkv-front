<template functional>
	<div
		...
		class="widget-layers-item pos-r"
	...
	>
		<header class="title-state fn-flex">
			...
			<div class="right z-index-editor header-action">
				...
				<Icon class="icon-button" type="md-add-circle" title="上移一层"
					  @click="parent.$emit('update-widget-z-index', { id: props.id, value: 1 })"/>
				<Icon class="icon-button" type="md-arrow-dropup-circle" title="置顶"
					  @click="parent.$emit('update-widget-z-index', { id: props.id, value: 'top' })"/>
			</div>
		</header>
		<div class="info fn-flex">
			<input
				type="text"
