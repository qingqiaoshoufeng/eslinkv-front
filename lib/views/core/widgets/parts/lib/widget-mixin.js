...
const mixins = {
    ...
    methods: {
        ...
        parseConfigValue(configParseMap = {}, localConfigValue = null) {
            ...
            // const mergedValue =globalConfigValue()
            console.log(this.config)
            // const inputConfig = Object.freeze(this.config || {})
            // const mergeInputValue = configMerge(inputConfig, mergedValue)
            const res = valueParser(mergedValue, _configParseMap)
            res.widget.name = res.widget.name || this.$parent.type
            res.layout.position.left = this.config.layout.position.left
            res.layout.position.top = this.config.layout.position.top

            res.layout.size.width = this.config.layout.size.width
            res.layout.size.height = this.config.layout.size.height
            console.log(res)
        ...
        updateConfig() {
            ...
            // window.GoldChart.mutations.updateConfig(this.config.widget.id, payload.value)
            // console.log(payload)
