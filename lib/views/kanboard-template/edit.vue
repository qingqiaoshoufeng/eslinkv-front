<template>
  <div class="layout-wrapper">
    <div class="main-container">
      <core ref="kanboardEditor" :class="{ screenshot: screenshotCreating }" @kanboard-edited="kanboardEdited = true"/>
          ...
          onOk: async () => {
            ...
            if (templateType !== 2) {
              ...
              if (snapshot) {
                ...
                const guidesSnapshot = await this.capture({selector: '.guides-wrapper', type: templateType})
